...
<body>
	...
	<form:form modelAttribute="book" action="/books/new/create" method="post" class="row g-3">
		...
		<div class="mb-3">
  			...
  			<form:input type="text" class="form-control" path="title" placeholder="Book Title" required="true"/>
		</div>
		<div class="mb-3">
  			<form:label path="author" class="form-label">Author: </form:label>
  			<form:input type="text" class="form-control" path="author" placeholder="Book Author" required="true"/>
		</div>
		<div class="mb-3">
